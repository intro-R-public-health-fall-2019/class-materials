...
# different new variable names
table4a %>%
  gather(`1999`, `2000`, key = "hello", value = "goodbye")

#without pipe
gather(data = table4a, `1999`, `2000`, key = "year", value = "cases")
```
...
table4a %>%
  gather(1999, 2000, key = "year", value = "cases")
# need single quotes to R knows its a column name and not a number
# this is true whenever column name starts with a number or has a space
```
...
table_century %>% 
  unite(year_combined, century, year, sep = "")
