...
### scratch
x <- 15
x %% 3  # checks whether divisible by 3
(x %% 3 == 0)  # if divisible by 3, get TRUE, if not divisible by 3, get FALSE
x %% 5  # checks whether divisible by 5
(x %% 5 == 0)
...
For functions that work with data, there are generally two types of arguments: ones that supply the data to comput on and ones that control the details of the computation to be done on that data.  For example:
