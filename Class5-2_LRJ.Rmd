...
In Module 5, we are learning more about using R Markdown to create data analysis reports.  Another way to use R Markdown to share you work is to create a dashboard using Flexdashboard.  Some of the material from today's class is adapted from "R for Data Science" by Grolemund and Wickham, section 29.6 and 29.7.2.  You can find these sections [here]](https://r4ds.had.co.nz/r-markdown-formats.html#dashboards) and [here](https://r4ds.had.co.nz/r-markdown-formats.html#shiny). You can find lots of other R Markdown formats, like presentations and websites in Chapter 29 of this books as well!
